...
namespace EZDose.Prescriptions
{
    ...
    public class PrescriptionManager
    {
        ...
        /// Rows: [0]=Evening, [1]=Noon, [2]=Morning, [3]=Spare
        /// Columns: Days 0-6
        /// </summary>
        private static int[,] BuildPillMatrix(MedicineEntry medicine, int dispensingDays)
        {
            ...
            for (var day = 0; day < days; day++)
            {
                ...
                matrix[0, day] = (int)medicine.EveningDosage;
                matrix[1, day] = (int)medicine.NoonDosage;
                matrix[2, day] = (int)medicine.MorningDosage;
            }
