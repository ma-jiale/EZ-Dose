...
namespace DA_Assets.FCU
{
    ...
    public class CurrentProject : FcuBase
    {
        ...
        public List<SyncData> LastImportedFrames { get => lastImportedFrames; set => lastImportedFrames = value; }

        [SerializeField] List<SyncHelper> localPrefabs = new List<SyncHelper>();
        public List<SyncHelper> LocalPrefabs { get => localPrefabs; set => localPrefabs = value; }
