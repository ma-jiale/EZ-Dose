...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.manage_patients_action = QAction(MainWindow)
        self.manage_patients_action.setObjectName(u"manage_patients_action")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.settings_action.setText(QCoreApplication.translate("MainWindow", u"\u670d\u52a1\u5668URL\u8bbe\u7f6e", None))
        self.manage_patients_action.setText(QCoreApplication.translate("MainWindow", u"\u7ba1\u7406\u60a3\u8005", None))
