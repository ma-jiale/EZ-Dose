...
"}")
        ...
        self.is_connect_dispenser = QLabel(self.taskwidget)
        self.is_connect_dispenser.setObjectName(u"is_connect_dispenser")
        self.is_connect_dispenser.setMinimumSize(QSize(0, 30))
        self.is_connect_dispenser.setMaximumSize(QSize(16777215, 20))

        self.verticalLayout_3.addWidget(self.is_connect_dispenser)
        ...
        self.is_read_RFID = QLabel(self.taskwidget)
        self.is_read_RFID.setObjectName(u"is_read_RFID")
        self.is_read_RFID.setMinimumSize(QSize(0, 30))
        self.is_read_RFID.setMaximumSize(QSize(16777215, 20))

        self.verticalLayout_3.addWidget(self.is_read_RFID)

        self.prescription_status = QLabel(self.taskwidget)
        self.prescription_status.setObjectName(u"prescription_status")
        self.prescription_status.setMinimumSize(QSize(0, 30))
        self.prescription_status.setMaximumSize(QSize(16777215, 30))

        self.verticalLayout_3.addWidget(self.prescription_status)

        self.is_finish_dispense = QLabel(self.taskwidget)
        self.is_finish_dispense.setObjectName(u"is_finish_dispense")
        self.is_finish_dispense.setMinimumSize(QSize(0, 30))
        self.is_finish_dispense.setMaximumSize(QSize(16777215, 30))

        self.verticalLayout_3.addWidget(self.is_finish_dispense)

        self.is_open_plate = QLabel(self.taskwidget)
        self.is_open_plate.setObjectName(u"is_open_plate")
        self.is_open_plate.setMinimumSize(QSize(0, 30))
        self.is_open_plate.setMaximumSize(QSize(16777215, 30))

        self.verticalLayout_3.addWidget(self.is_open_plate)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.is_connect_dispenser.setText(QCoreApplication.translate("MainWindow", u"\u8fde\u63a5\u5206\u836f\u673a", None))
        ...
        self.is_read_RFID.setText(QCoreApplication.translate("MainWindow", u"\u8bfb\u53d6RFID", None))
        self.prescription_status.setText(QCoreApplication.translate("MainWindow", u"\u83b7\u53d6\u5904\u65b9", None))
        self.is_finish_dispense.setText(QCoreApplication.translate("MainWindow", u"\u5206\u836f\u54c1", None))
        self.is_open_plate.setText(QCoreApplication.translate("MainWindow", u"\u9000\u51fa\u836f\u76d8", None))
